#train model on csv file, output is trained .pth file
import pandas as pd
import torch
...
excel_file = 'E:/posture_detections/csv/CSV_COMBINED.xls' 
...
class PoseDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label_map = {'sitting': 0, 'standing': 1, 'squatting': 2}
...
hidden_size = 128
num_classes = 3   # Number of classes (sitting, standing, squatting)  #increase class is you want to train on more poses(add labels to csv file accordingly)
