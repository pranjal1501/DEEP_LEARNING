...
hidden_size = 128
num_classes = 4   # Number of classes (sitting, standing, squatting)

model = MLP(input_size, hidden_size, num_classes)
model.load_state_dict(torch.load('E:/posture_detections/usecase_leaning/pose_classifiication_with_leaning.pth'))
model.eval()

# Load your testing CSV file for predictions
csv_file = "E:/posture_detections/TESTING/FRONTVIEW_TEST/testing_2.csv"
...
video_file = "E:/posture_detections/TESTING/FRONTVIEW_TEST/testing_2.mp4"
cap = cv2.VideoCapture(video_file)

# Initialize Video Writer for output video
output_file = 'output_video_with_predictions_leaning.avi'
...
while cap.isOpened():
    ...
    class_name = {0: 'Sitting', 1: 'Standing', 2: 'Squatting', 3: 'leaning'}[predicted_class]
